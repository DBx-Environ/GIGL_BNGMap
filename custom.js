...
// 2. Attach Elements Directly to the Map Container
...
// 3. Run immediately when map container is ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', attachCustomMapOverlays);
} else {
